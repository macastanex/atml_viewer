...
This app was generated by `slcli webapp new ATMLFileManager` as a hosted Angular 20 starter for SystemLink.
...
- three list-and-detail starter routes ready for inspection, selection, and edit workflows

## Enabled Starter Routes

home, assets, master-detail
...
```bash
slcli webapp publish dist/atmlfilemanager --name "ATML File Manager"
```
